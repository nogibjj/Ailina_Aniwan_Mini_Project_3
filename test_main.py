...
def test_statistics():
    ...
    print(
        f"Expected mean: {expected_mean_spirit:.2f}, "
        f"Calculated mean: {process_mean(df, 'spirit_servings'):.2f}"
    )
    print(
        f"Expected median: {expected_median_spirit:.2f}, "
        f"Calculated median: {process_median(df, 'spirit_servings'):.2f}"
    )
    print(
        f"Expected standard deviation: {expected_std_spirit:.2f}, "
    ...
    print(
        f"Expected mean: {expected_mean_wine:.2f}, "
        f"Calculated mean: {process_mean(df, 'wine_servings'):.2f}"
    )
    print(
        f"Expected median: {expected_median_wine:.2f}, "
        f"Calculated median: {process_median(df, 'wine_servings'):.2f}"
    )
    print(
        f"Expected standard deviation: {expected_std_wine:.2f}, "
